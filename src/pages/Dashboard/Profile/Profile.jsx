...
export default function Profile() {
    ...
    // Hide Profile component when on /change-password route
        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-white p-4">
            ...
            <div className="w-full max-w-2xl mt-4">
                <Tabs
                    ...
                    centered
                    onChange={(key) => {
                        if (key === "2") navigate("/change-password");
                        else if (key === "3") navigate("/user-list");
                    }}
                >
                    <TabPane tab={<span className="text-pink-500 font-semibold">Edit Profile</span>} key="1">
                        ...
                        <div className="bg-white p-6 mt-4">
                            ...
                            <div className="space-y-4">
                                ...
                                <Button type="primary" className="w-full bg-[#ED1E79] hover:bg-pink-600 text-white">
                                    Save & Change
                                </Button>
                            </div>
                        </div>
                    </TabPane>
                    <TabPane tab="Change Password" key="2"></TabPane>
                    <TabPane tab="User List" key="3"></TabPane>
                </Tabs>
            </div>
        </div>
    );
